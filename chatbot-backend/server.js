...
import dotenv from "dotenv"; // Add dotenv to manage environment variables
...
async function getChatbotResponse(query) {
  try {
    const apiKey = process.env.OPENAI_API_KEY;  // Use the API key from the environment variable
